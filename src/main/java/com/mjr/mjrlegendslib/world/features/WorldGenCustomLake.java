...
public class WorldGenCustomLake extends WorldGenerator {
	...
	public WorldGenCustomLake(Block blockIn) {
		this.block = blockIn;
	}
				...
				for (int l2 = 0; l2 < 16; ++l2) {
					for (int k = 0; k < 8; ++k) {
						boolean flag = !aboolean[(k1 * 16 + l2) * 8 + k]
								&& (k1 < 15 && aboolean[((k1 + 1) * 16 + l2) * 8 + k] || k1 > 0 && aboolean[((k1 - 1) * 16 + l2) * 8 + k] || l2 < 15 && aboolean[(k1 * 16 + l2 + 1) * 8 + k] || l2 > 0 && aboolean[(k1 * 16 + (l2 - 1)) * 8 + k] || k < 7
										&& aboolean[(k1 * 16 + l2) * 8 + k + 1] || k > 0 && aboolean[(k1 * 16 + l2) * 8 + (k - 1)]);
					...
					for (int k3 = 0; k3 < 16; ++k3) {
						for (int k4 = 0; k4 < 8; ++k4) {
							boolean flag1 = !aboolean[(j2 * 16 + k3) * 8 + k4]
									&& (j2 < 15 && aboolean[((j2 + 1) * 16 + k3) * 8 + k4] || j2 > 0 && aboolean[((j2 - 1) * 16 + k3) * 8 + k4] || k3 < 15 && aboolean[(j2 * 16 + k3 + 1) * 8 + k4] || k3 > 0 && aboolean[(j2 * 16 + (k3 - 1)) * 8 + k4]
							...
							if (flag1 && (k4 < 4 || rand.nextInt(2) != 0) && worldIn.getBlockState(position.add(j2, k4, k3)).getMaterial().isSolid()) {
								worldIn.setBlockState(position.add(j2, k4, k3), block.getDefaultState(), 2);
							}
						}
					}
				}
				...
				for (int k2 = 0; k2 < 16; ++k2) {
					for (int l3 = 0; l3 < 16; ++l3) {
						...
						if (worldIn.canBlockFreezeWater(position.add(k2, l4, l3))) {
							worldIn.setBlockState(position.add(k2, l4, l3), block.getDefaultState(), 2);
						}
					}
				}
			}
				...
				for (int j2 = 0; j2 < 16; ++j2) {
					for (int k3 = 0; k3 < 16; ++k3) {
						for (int k4 = 0; k4 < 8; ++k4) {
							...
							if (flag1 && (k4 < 4 || rand.nextInt(2) != 0) && worldIn.getBlockState(position.add(j2, k4, k3)).getMaterial().isSolid()) {
								worldIn.setBlockState(position.add(j2, k4, k3), state, 2);
							}
						}
					}
				}
			...
			if (this.block.getDefaultState().getMaterial() == Material.WATER) {
				for (int k2 = 0; k2 < 16; ++k2) {
					for (int l3 = 0; l3 < 16; ++l3) {
						...
						if (worldIn.canBlockFreezeWater(position.add(k2, l4, l3))) {
							worldIn.setBlockState(position.add(k2, l4, l3), state, 2);
						}
					}
				}
			}
